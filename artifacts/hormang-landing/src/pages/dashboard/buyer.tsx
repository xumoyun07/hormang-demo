...
import { Search, Star, ShieldCheck, LogOut } from "lucide-react";
      ...
      <main className="max-w-2xl mx-auto px-4 py-12">
        ...
        >
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground text-sm">Sizning Hormang xaridor panelingiz</p>
          </div>

          <div className="grid gap-4">
            {[
              { icon: Search, title: "Xizmat qidirish", desc: "Mahalliy mutaxassislarni toping", action: () => setLocation("/") },
              { icon: Star, title: "Mening buyurtmalarim", desc: "Barcha buyurtmalar va sharhlar" },
              { icon: ShieldCheck, title: "Profil sozlamalari", desc: "Ma'lumotlarni tahrirlash" },
