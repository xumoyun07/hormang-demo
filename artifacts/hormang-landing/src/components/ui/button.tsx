    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            "text-white shadow-[0_8px_20px_-4px_hsl(145,65%,38%,0.45)] hover:shadow-[0_12px_28px_-4px_hsl(145,65%,38%,0.55)] hover:-translate-y-0.5 active:translate-y-0 active:shadow-sm": variant === "default",
            "text-white shadow-[0_8px_16px_-4px_hsl(214,89%,52%,0.4)] hover:shadow-[0_12px_24px_-4px_hsl(214,89%,52%,0.5)] hover:-translate-y-0.5 active:translate-y-0 active:shadow-sm [background:var(--brand-gradient-45)]": variant === "secondary",
            ...
            "underline-offset-4 hover:underline [background:var(--brand-gradient-text)] bg-clip-text text-transparent [background:none] text-primary": variant === "link",
